  ...
  useEffect(() => {
    ...
    reservationsApi
      ...
      .then((list) => {
        ...
        const byStatus: Record<string, number> = { PENDING: 0, CONFIRMED: 0, REFUSED: 0, CANCELED: 0 };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4 border border-gray-100">
            ...
            <p className="text-2xl font-bold text-gray-900 mt-1">{reservationsByStatus.CONFIRMED ?? 0}</p>
          </div>
        </div>
