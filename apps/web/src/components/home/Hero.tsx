...
export default function Hero() {
  return (
    <section
      className="relative flex flex-col h-screen overflow-hidden bg-gray-300 bg-[url('/Hero.png')] bg-cover bg-no-repeat bg-center sm:bg-center md:bg-center min-h-[100dvh]"
    >
      <div className="absolute inset-0 bg-gray-900/80 sm:bg-gray-900/45 md:bg-gray-900/70 z-[0]" aria-hidden />
