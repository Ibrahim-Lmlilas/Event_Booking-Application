...
export default function ParticipantSidebar() {
  ...
  const participantMenuItems = [
    { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard/participant' },
    { icon: Calendar, label: 'My Events', path: '/dashboard/participant/events' },
    { icon: Ticket, label: 'My Reservations', path: '/dashboard/participant/reservations' },
    { icon: Settings, label: 'Settings', path: '/dashboard/participant/settings' },
  ];
